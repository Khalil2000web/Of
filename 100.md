...
<style>.css-c74rht{position:absolute;left:4.92%;top:3%;width:80%;height:auto;cursor:pointer;padding: 0;margin: 0;} </style>
<main style="overflow-y:auto;overflow-x:hidden;position:relative;width100vw;min-height:800vw;display:flex;flex-direction:column;align-items:center;background-color: #000;padding:0;margin:0;">
