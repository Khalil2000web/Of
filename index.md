...
<div class="video-container"><canvas></canvas><video crossorigin="anonymous" poster="https://pub-f4c4477afe9541f7a586037aaee49080.r2.dev/IMG_8992.jpeg" src="https://pub-19025506a9754f36baa46a24e6f84719.r2.dev/video-output-41CC8F37-AEAD-457B-9DD6-98182EE735FD-1.mov" muted loop autoplay playsinline preload="auto" style="display:none;"></video><div class="spinner"></div><div class="sound-btn"><img src="https://khaliil.com/static/images/icon-mute.svg" alt="Toggle Sound"></div><div class="error-message"></div><div class="play-btn"></div></div>
...
<div class="video-container"><canvas></canvas><video crossorigin="anonymous" poster="https://pub-f4c4477afe9541f7a586037aaee49080.r2.dev/IMG_8920.jpeg" src="https://pub-19025506a9754f36baa46a24e6f84719.r2.dev/IMG_8716.mov" muted loop autoplay playsinline preload="auto" style="display:none;"></video><div class="spinner"></div><div class="sound-btn"><img src="https://khaliil.com/static/images/icon-mute.svg" alt="Toggle Sound"></div><div class="error-message"></div><div class="play-btn"></div></div>
...
<div class="video-container"><canvas></canvas><video crossorigin="anonymous" src="https://hf.r2.dev/IMG_8716.mov" muted loop autoplay playsinline preload="auto" style="display:none;"></video><div class="spinner"></div><div class="sound-btn"><img src="https://khaliil.com/static/images/icon-mute.svg" alt="Toggle Sound"></div><div class="error-message"></div><div class="play-btn"></div></div>
...
<div class="video-container"><canvas></canvas><video crossorigin="anonymous" src="https://pub-65e50ac10e764e13b41536c10d90f540.r2.dev/PICT0017.mov" muted loop autoplay playsinline preload="auto" style="display:none;"></video><div class="spinner"></div><div class="sound-btn"><img src="https://khaliil.com/static/images/icon-mute.svg" alt="Toggle Sound"></div><div class="error-message"></div><div class="play-btn"></div></div>
...
containers.forEach(container => {
  ...
  playBtn.addEventListener('click', () => {
    ...
    video.play().catch(() => {
      displayErrorMessage(
        ...
        "The video is unavailable. This may be due to a network issue, an unsupported format, or missing permissions."
      );
    });
  });
  ...
  soundBtn.addEventListener('click', () => {
    if (video.muted) {
      if (currentlyUnmutedVideo && currentlyUnmutedVideo !== video) {
        ...
        updateSoundIcon(currentlyUnmutedVideo, 'https://tour.khaliil.com/static/images/icon-mute.svg');
      }
      video.muted = false;
      currentlyUnmutedVideo = video;
      updateSoundIcon(video, 'https://tour.khaliil.com/static/images/icon-volume.svg');
    } else {
      video.muted = true;
      currentlyUnmutedVideo = null;
      updateSoundIcon(video, 'https://tour.khaliil.com/static/images/icon-mute.svg');
    }
  });

  function updateSoundIcon(vid, iconSrc) {
  ...
  const observer = new IntersectionObserver(entries => {
    entries.forEach(entry => {
      if (!entry.isIntersecting && !video.muted) {
        video.muted = true;
        updateSoundIcon(video, 'https://khaliil.com/static/images/icon-mute.svg');
  ...
  video.addEventListener('stalled', () => {
    ...
    setTimeout(() => {
      if (video.readyState < 2) {
        displayErrorMessage(
          "VIDEO COULD NOT LOAD",
          "Video failed to load after several attempts."
        );
      }
    }, 5000);
  });
  ...
  video.play().catch(() => {
    showPlayButton(); // fallback if autoplay fails
  });

  // Fallback error message if video doesn't load in time
  setTimeout(() => {
    if (video.readyState < 2) {
      displayErrorMessage(
        "VIDEO COULD NOT LOAD",
        "The video failed to load after several attempts. Please check the video URL or try again later."
      );
    }
  }, 7000);
});
